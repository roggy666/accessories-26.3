...
public abstract class InventoryScreenMixin {
    ...
    private static void accessories$wrapWithArmorLookup(GuiGraphicsExtractor guiGraphics, int i, int j, int k, int l, float f, Vector3f vector3f, Quaternionf quaternionf, Quaternionf quaternionf2, LivingEntity livingEntity, Operation<Void> original) {
